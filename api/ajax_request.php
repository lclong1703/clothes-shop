...
function addToCart() {
	...
	if(!$isFind) {
		$sql = "select hanghoa.*, loaihanghoa.TenLoaiHang,hinhhanghoa.* as category_name from hanghoa left join loaihanghoa on hanghoa.MaLoaiHang = loaihanghoa.MaLoaiHang left join hinhhanghoa on hanghoa.MSHH=hinhhanghoa.MSHH where hanghoa.MSHH = $id";
